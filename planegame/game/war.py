...
from constants import BG_IMG, IMG_GAME_TITLE, IMG_GAME_START_BTN, BG_MUSIC, BG_IMG_OVER, TEXT_SCORE_COLOR
        ...
        while True:
            ...
            if self.status == self.READY:
                ...
                score_his = self.score_font.render(
                    '{0}'.format(self.rest.get_max_core()), False, TEXT_SCORE_COLOR
                )
