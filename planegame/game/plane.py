"""
                飞机的基类
     我方的飞机   敌方的小型飞机    敌方的中型飞机    敌方的小型飞机
"""
import random

import pygame

from constants import OUR_PLANE_IMG_1, OUR_DESTROY_IMG_LIST, OUR_PLANE_IMG_2, \
    SMALL_ENEMY_PLANE_IMG_LIST, SMALL_ENEMY_DESTROY_IMG_LIST, SMALL_ENEMY_PLANE_DOWN_SOUND
...
class OurPlane(Plane):
    """我方的飞机"""
    # 飞机的图片
    plane_images = [OUR_PLANE_IMG_1, OUR_PLANE_IMG_2]
    # 飞机爆炸的图片
    destroy_images = OUR_DESTROY_IMG_LIST
    # 坠毁的音乐地址
    down_sound_src = None
...
class SmallEnemyPlane(Plane):
    """敌方小型飞机类"""
    # 飞机的图片
    plane_images = SMALL_ENEMY_PLANE_IMG_LIST
    # 飞机爆炸的图片
    destroy_images = SMALL_ENEMY_DESTROY_IMG_LIST
    # 坠毁的音乐地址
    down_sound_src = SMALL_ENEMY_PLANE_DOWN_SOUND
